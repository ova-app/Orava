...
1. `Orava___Master_Plan_v4.md` — §3 Modèle de monétisation (tarifs, upsells, revenus additionnels, objectifs ARR), §4 (gating Free/Pro/Coach par feature), §13 KPI conversion.
...
- **Revenus additionnels** : commission marketplace 15 %, Pass Orava B2B salles, OravaFeed 3,99 € — crédibles à ce stade ou Phase 3+ lointaine/spéculative ?
