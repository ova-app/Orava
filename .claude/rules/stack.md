...
CREATE TABLE IF NOT EXISTS local_sessions (
  id TEXT PRIMARY KEY,        -- = workout_id Supabase ; PK = ORA-062 (anti-doublon retry)
...
Migrations locales versionnées via `PRAGMA user_version` (ORA-061) — voir `rules/database.md`.
