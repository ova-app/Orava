...
|---|---|---|---|
| 1 | [01-cest-quoi-ova.md](./01-cest-quoi-ova.md) | Le produit : à quoi sert l'app, pour qui, ses idées fortes | 10 min |
...
| 5 | [05-concepts-metier.md](./05-concepts-metier.md) | Les idées propres à Ova : Myo, PR, Mode Fantôme, Prédictif | 30 min |
...
- **[`Ova___Master_Plan_v4.md`](../Ova___Master_Plan_v4.md)** — **la source de vérité produit**. Vision, phases, features.
