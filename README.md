...
> Source de vérité produit : [`Ova___Master_Plan_v4.md`](./Ova___Master_Plan_v4.md)
...
├── Ova___Master_Plan_v4.md — vision produit
...
- Accès au projet Supabase Ova (demander les clés au propriétaire — voir Config ci-dessous)
